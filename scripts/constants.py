...
#PP_DB_DEFAULT_INI_FILE_SECTION = 'rhaeussler'
...
if platform == 'win32':
    PP_DB_DEFAULT_INI_FILE_SECTION = 'preproc-proxy'
    #PP_DB_DEFAULT_INI_FILE_SECTION = 'preproc-bastion'
    ...
    PP_DB_DEFAULT_INI_FILE_SECTION = 'preproc'
