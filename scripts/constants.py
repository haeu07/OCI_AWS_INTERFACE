...
PP_SCRIPTS_SUB_PATH = os.path.normpath('OCI_AWS_INTERFACE\\scripts')
PP_LOG_SUB_PATH = os.path.normpath('OCI_AWS_INTERFACE\\log')
PP_DATA_SUB_PATH = os.path.normpath('OCI_AWS_INTERFACE\\local_data')
